# scafctl-plugin-github - AI Agent Instructions

## Overview

scafctl provider plugin implementing the **github** provider.

## Key Patterns

- **Plugin SDK**: Uses `github.com/oakwood-commons/scafctl-plugin-sdk`
- **Entry point**: `cmd/scafctl-plugin-github/main.go` calls `sdkplugin.Serve()`
